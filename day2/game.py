...
import random
import turtle
# клавиши Alt+enter - импортирует библиотеку
# CTRL + D дублирует выделенный текст
...
while True:
    ...
    check_enemy_count()  #проверяем количество врагов
    check_interceptions()  #проверяем перехваты
    move_missiles(missiles=our_missiles)  #двигаем свои ракеты
    move_missiles(missiles=enemy_missiles)  #двигаем вражеские ракеты
